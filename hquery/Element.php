<?php
namespace system\lib\hquery;

// ------------------------------------------------------------------------
class_exists('system\lib\hquery\\Node', false) or require_once __DIR__ . DIRECTORY_SEPARATOR . 'Node.php';
...
class Element extends Node implements \ArrayAccess {
     ...
     *
     * @return \system\lib\hquery\Element
     */
     ...
     *
     * @return \system\lib\hquery\Element parent
     */
     ...
     *
     * @return \system\lib\hquery\Element children
     */
     ...
     *
     * @return \system\lib\hquery\Element previousElementSibling
     */
     ...
     *
     * @return \system\lib\hquery\Element nextElementSibling
     */
...
// ------------------------------------------------------------------------
// PSR-0 alias
class_exists('system\lib\hquery\\hQuery_Element', false) or class_alias('system\lib\hquery\\Element', 'hQuery_Element', false);
