...
use system\lib\hquery\Exception\ClassInstantiationFailedException;
use system\lib\hquery\Exception\DiscoveryFailedException;
use system\lib\hquery\Exception\StrategyUnavailableException;
